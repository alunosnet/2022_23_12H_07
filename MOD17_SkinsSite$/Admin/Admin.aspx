<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="MOD17_SkinsSite_.Admin.Admin" %>
        ...
        $(document).ready(function () {
            $("#btnlista").on('click', function (e) {
                ...
                function OnSuccess(response) {
                    alert(response.d);
                    var listaSkins = JSON.parse(response.d);
                    for (var i = 0; i < listaSkins.length; i++) {
                        $("#divLista").append(listaSkins[i].nome + "<br/>");
                    }
                }
            });
